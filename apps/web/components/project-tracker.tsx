...
export function ProjectTracker() {
  ...
  return (
    <main className="shell">
      <header className="pageHeader"><div><p className="eyebrow">Client delivery</p><h1>Project tracker</h1><p>Track audit, demo, build, client review, launch and maintenance with evidence-backed progress.</p></div></header>
